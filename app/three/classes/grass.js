...
export class Grass extends THREE.Object3D {
  ...
  async fetchAssets() {
    ...
    _whiteFlower = (await gltfLoader.loadAsync("flower_white.glb")).scene
      .children[0];
    _blueFlower = (await gltfLoader.loadAsync("flower_blue.glb")).scene
      .children[0];
    _yellowFlower = (await gltfLoader.loadAsync("flower_yellow.glb")).scene
      .children[0];
